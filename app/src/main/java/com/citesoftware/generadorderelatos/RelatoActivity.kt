    ...
    fun generarUbicacion(tiempo: Int): String {
        ...
        if(intent.getBooleanExtra("RoF", true)) {
            ...
            when(tiempo){
                ...
                1 -> lista = listOf(getString(R.string.ubicacion1),
                ...
                2, 3 -> lista = listOf(getString(R.string.ubicacion1),
                    getString(R.string.ubicacion3),
                    ...
                    getString(R.string.ubicacion54),
                    getString(R.string.ubicacion55),
                    getString(R.string.ubicacion56))
            }
        ...
        if(intent.getBooleanExtra("RoF", true)) {
            ...
            when(tiempo){
                ...
                1 -> lista = listOf(
                    ...
                    getString(R.string.locacion1),
                    getString(R.string.locacion2),
                    getString(R.string.locacion5),
                    getString(R.string.locacion6),
                    getString(R.string.locacion9),
                    getString(R.string.locacion11)
                )
                2, 3 -> lista = listOf(
                    getString(R.string.ubicacion2),
                    getString(R.string.ubicacion4),
                    ...
                    getString(R.string.locacion1),
                    getString(R.string.locacion2),
                    getString(R.string.locacion3),
                    getString(R.string.locacion4),
                    getString(R.string.locacion5),
                    getString(R.string.locacion6),
                    getString(R.string.locacion7),
                    getString(R.string.locacion8),
                    getString(R.string.locacion9),
                    getString(R.string.locacion10))
            }
        ...
        if(intent.getBooleanExtra("RoF", true)) {
            ...
            when(tiempo){
                ...
                1 -> lista = listOf(getString(R.string.personajes1),
                    ...
                    getString(R.string.personajes36),
                    getString(R.string.personajes37))
                ...
                2, 3 -> lista = listOf(getString(R.string.personajes1),
                    ...
                    getString(R.string.personajes36),
                    getString(R.string.personajes37),
                    getString(R.string.personajes38))
            }
